...
program linSolve
 ...
 read(99,*) scheme
  ...
  !
  call tecOutput(sol(1:numVars,il_bnd+nguard:iu_bnd-nguard,jl_bnd+nguard:ju_bnd-nguard,kl_bnd+nguard*iins3d:ku_bnd),&
  ...
  if (errorOutput) then
     ...
     write(*,'(A,A)') "[I] Writing output file = ",trim(filename)
     !
     call tecOutput(error(1:numVars,il_bnd+nguard:iu_bnd-nguard,jl_bnd+nguard:ju_bnd-nguard,kl_bnd+nguard*iins3d:ku_bnd),&
                 coords(il_bnd+nguard:iu_bnd-nguard,jl_bnd+nguard:ju_bnd-nguard,kl_bnd+nguard*iins3d:ku_bnd-nguard*iins3d,1:3),&       
                 nxb,nyb,nzb,numVars,filename)
     !
#if (RHSTEST==1)
